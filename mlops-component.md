...
문제 해결을 위한 데이터를 분석/가공하고, 학습시켜 모델을 최적화시키며 그 모델들을 서버에 배포시켜 예측을 하는 등 이 일련의 과정들을 ML 워크플로우라고 부른다. 하기 그림과 같은 플로우로 정의할 수 있다.

![ML Workflow](./img/ml_workflow.png)

- 모델 실험 단계: 사용될 모델을 실험
- 모델 생산 단계: 실험된 모델을 학습/배포
...
참조: [모두의 MLops](https://mlops-for-all.github.io/docs/introduction/component/)